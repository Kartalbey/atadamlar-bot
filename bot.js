...
client.on("message", message => {
    ...
    if (message.content === prefix + "bilgi") {
        const embed = new Discord.RichEmbed()
            ...
            .addField("Bot Sahibi", `<@529037946746306581>`, true)
...
client.on('guildCreate', async guild => {
  const girismesaj = [
    ...
    'Destek Sunucumuz : https://discord.gg/fybK8j2',
'Siz De Kendi Botunuzu Yapmak İstiyorsanız: \n https://youtube.com/c/karmakarisiktv27 Kanalını Ziyaret Ediniz!    '
